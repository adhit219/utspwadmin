          ...
          <li class="nav-item nav-profile border-bottom">
            <a href="#" class="nav-link flex-column">
              ...
              <div class="nav-profile-text d-flex ml-0 mb-3 flex-column">
                <span class="font-weight-semibold mb-1 mt-2 text-center">Bocah UMM</span>
                <span class="text-secondary icon-sm text-center">Rp. 345.678.999,-</span>
              </div>
            </a>
          </li>
                    ...
                    <div class="table-responsive">
                      <table class="table custom-table text-dark">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="../assets/images/faces/subro.jpg" class="mr-2" alt="image" /> Subro Mulisi </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="../assets/images/faces/aku.png" class="mr-2" alt="image" /> Rizqi Kharisma </td>
                            <td>
                              <div class="d-flex">
                                <span class="pr-2 d-flex align-items-center">80%</span>
                          ...
                          <tr>
                            <td>
                              <img src="../assets/images/faces/adhit.png" class="mr-2" alt="image" /> Satria Adhitama </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="../assets/images/faces/adi.png" class="mr-2" alt="image" /> Hadiatullah </td>
                            <td>
                              <div class="d-flex">
                                <span class="pr-2 d-flex align-items-center">40%</span>
                          ...
                          <tr>
                            <td>
                              <img src="../assets/images/faces/face7.jpg" class="mr-2" alt="image" /> Sujarwo Tejo </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="../assets/images/faces/face6.jpg" class="mr-2" alt="image" /> Jarwo Sutejo </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="../assets/images/faces/face9.jpg" class="mr-2" alt="image" /> Bocah UMM </td>
                            <td>
                              <div class="d-flex">
                                <span class="pr-2 d-flex align-items-center">65%</span>
